...
void IK_solve::init_save()
{
    ...
    addr = "/home/robit/catkin_ws/src/ikwalk/init/is0512.h";
...
void IK_solve::solve(double pX_r, double pY_r, double pZ_r, double RYaw, double pX_l, double pY_l, double pZ_l, double LYaw, int body)
{
    ...
    g_DXL_ID_position[18] -= ang2pos(InvLegAngle[4]*rad2deg + Pitch_ADD_Angle*balanceInfo.ankle_amp) + ang.ang18;            //left_pitch
    ...
    g_DXL_ID_position[19] += ang2pos(InvLegAngle[10]*rad2deg + Pitch_ADD_Angle*balanceInfo.ankle_amp) + ang.ang19;           //right_pitch
